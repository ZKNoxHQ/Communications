...
\begin{frame}{Post-quantum signature candidates}
  \begin{center}
    \begin{tabular}{|l|c|c|c|}
      ...
      \hline
      Gas cost verification & \uncover<4->{\multirow{2}{*}{3.8M} & \multirow{2}{*}{8.0M} & \multirow{2}{*}{--}}\\
      ...
      \hline
      Aggregation & \uncover<6->{\link{https://eprint.iacr.org/2024/311}{Possible} & no & no}\\
      \hline
...
\begin{frame}{Future of PQ accounts}
  \begin{itemize}
    ...
    \eiplink{8051} (MLDSA), \eiplink{8052} (FALCON), \eiplink{7885} (NTT), SHAKE precompile, Vectorized arithmetic precompile.\\
    \pause
    The remaining cost is call data ($\Box$ = 32B):
  \end{itemize}
