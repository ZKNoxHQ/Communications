...
\begin{frame}{Post-quantum signature candidates}
  \begin{center}
    \begin{tabular}{|l|c|c|c|}
      ...
      \hline
      Public key & \uncover<2->{897B & \textcolor{orange}{1312B} & 32B}\\
      \hline
      Gas cost verification & \uncover<2->{\multirow{2}{*}{3.8M} & \multirow{2}{*}{8.0M} & \multirow{2}{*}{--}}\\
      without precompile & \uncover<2->{& &}\\
      \hline
      Hardware  & \uncover<3->{\textcolor{orange}{requires a lot} & \textcolor{green}{yes, see later} & \multirow{2}{*}{--}}\\
      implementation & \uncover<3->{\textcolor{orange}{of RAM}  & \textcolor{green}{in this talk} &}\\
      \hline
      Aggregation & \uncover<3->{\link{https://eprint.iacr.org/2024/311}{Possible} & no & no}\\
      \hline
      TSS & \uncover<3->{okay for small $n$ & yes & no}\\
      \hline
      PK recovery & \uncover<3->{yes & no & no}\\
      \hline
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{\eiplink{8051}: MLDSA}
  ...
  \onslide<6->{Instead of hundreds of hashes, the public key is stored in expanded form on-chain.}
...
\begin{frame}{On-chain data gas cost (with the current structure)}
  \centering
  \begin{tabular}{|c|lr|lr|}
    \hline
    & \multicolumn{2}{c|}{\textbf{Create Account}} & \multicolumn{2}{c|}{\textbf{Send Transaction}}\\
    &  & Gas & & Gas\\
    \hline
    & {\tiny create2} & $32000$ & {\tiny extcodecopy} & $2600$\\
    {\tiny ecrecover} & & & {\tiny call data sig} & $32B \times 16 = 512$ \\
    {\tiny falcon} & {\tiny call data pk} & $1024 \times 16 = 16 384$ & {\tiny call data sig} & $666B \times 16 = 10656$ \\
    & {\tiny store pk} & $1024B \times 200 = 204 800$ & {\tiny copy pk} & $1024B \times 100 \div 32 = 3 200$ \\
    & {\tiny total} & \textcolor{green}{$254$k} & {\tiny total} & \textcolor{green}{$17$k}\\
    \hline
    & {\tiny create2} & $32000$ & {\tiny extcodecopy} & $2600$\\
    {\tiny ecrecover} &  & & {\tiny call data sig} & $32B \times 16 = 512$ \\
    {\tiny falconrecover} & & & {\tiny call data sig} & $666B \times 16 = 10656$ \\
    & {\tiny total} & \textcolor{green}{$32$k} & {\tiny total} & \textcolor{green}{$13$k}\\
    \hline
    & {\tiny create2} & $32000$ & {\tiny extcodecopy} & $2600$\\
    {\tiny ecrecover} & & & {\tiny call data sig} & $32B \times 16 = 512$ \\
    {\tiny mldsa} & {\tiny call data pk} & $\textcolor{red}{20512} \times 16 = 328 192$ & {\tiny call data sig} & $2420B \times 16 = 38 720$ \\
    & {\tiny store pk} &  $\textcolor{red}{20512} \times 200 = 4 102 400$ & {\tiny copy pk} & $\textcolor{red}{20512} \times 100 \div 32 = 64100$\\
    & {\tiny total} & \textcolor{green}{$4462$k} & {\tiny total} & \textcolor{green}{$106$k}\\
    \hline
  \end{tabular}
\end{frame}

\begin{frame}{On-chain data gas cost (estimated)}
  \centering
  \begin{tabular}{|c|lr|lr|}
    \hline
    & \multicolumn{2}{c|}{\textbf{Create Account}} & \multicolumn{2}{c|}{\textbf{Send Transaction}}\\
    ...
    & {\tiny create2} & $32000$ & {\tiny extcodecopy} & $2600$\\
    {\tiny ecrecover} & & & {\tiny call data sig} & $32B \times 16 = 512$ \\
    {\tiny falcon} & {\tiny call data pk} & $896B \times 16 = 14 336$ & {\tiny call data sig} & $666B \times 16 = 10656$ \\
    & {\tiny store pk} & $896B \times 200 = 179 200$ & {\tiny copy pk} & $896B \times 100 \div 32 = 2 800$ \\
    & {\tiny total} & \textcolor{green}{$226$k} & {\tiny total} & \textcolor{green}{$17$k}\\
    \hline
    & {\tiny create2} & $32000$ & {\tiny extcodecopy} & $2600$\\
    {\tiny ecrecover} & & & {\tiny call data sig} & $32B \times 16 = 512$ \\
    {\tiny falconrecover} && & {\tiny call data sig} & $666B \times 16 = 10656$ \\
    ...
    & {\tiny create2} & $32000$ & {\tiny extcodecopy} & $2600$\\
    {\tiny ecrecover} & & & {\tiny call data sig} & $32B \times 16 = 512$ \\
    {\tiny mldsa} & {\tiny call data pk} & $1312B \times 16 = 20 992$ & {\tiny call data sig} & $2420B \times 16 = 38 720$ \\
    & {\tiny store pk} &  $1312B \times 200 = 262 400$ & {\tiny copy pk} & $1312B \times 100 \div 32 = 4100$\\
    & {\tiny total} & \textcolor{green}{$315$k} & {\tiny total} & \textcolor{green}{$46$k}\\
    \hline
  \end{tabular}
\end{frame}
...
\begin{frame}{Future of PQ accounts}
  \begin{itemize}
    ...
    \end{itemize}
    The remaining cost is data call/store/copy.
    \pause
