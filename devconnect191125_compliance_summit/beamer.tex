...
\begin{frame}[t]{Demonstration}
  Let's see how it works in practice   \only<1-5>{(sorry for the UX)}\only<6->{: Railgun integration (thanks to Zy0n)}
  
  \begin{center}
  \only<2>{\includegraphics[width=6cm]{00000.png}}
  \only<3>{\includegraphics[width=6cm]{00001.png}}
  \only<4>{\includegraphics[width=6cm]{00002.png}}
  \only<5>{\includegraphics[width=6cm]{00003.png}}
  \only<6>{\includegraphics[width=12cm]{railgun-ledger.jpg}}
...
\begin{frame}{Conclusion and perspectives}
 \begin{itemize}[<+->]
  ...
  \item[$\Box$] HW FROST integration with Railgun developers,
