...
\author{\textbf{Renaud Dubois}, Simon Masson\\
ZKNox\\
...
%   \end{enumerate}
% \end{frame}
 \section{Introduction: Quantum Apocalypse }
    %\frame{\sectionpage}
...
Current proposals:
\begin{itemize}
\item FALCON (FNDSA FIP206 draft): EIP8052/EIP7619
\item Dilithium (MLDSA: FIPS204): EIP8051
\end{itemize}
...
\item \textcolor{red}{Private Payments (Privacy Pool, TC, Stealth, RAILGUN)}
...
\begin{frame}{Results}
  ...
  \hline
ETH\_FALCON	&ZKnox Use Keccak-ctr	&102M	&50 \\
\hline
ETH\_FALCON	&Starkware+ ZKNOX Keccak-ctr	&340M	&15 \\
\hline
FALZKON	Use &Blake2s-ctr	&41M	&125 \\
\hline
  \end{tabular}
...
\begin{itemize}
\item dramatical reduction of complexities (ZK and SC verifiers) (x12 gains)
\item first hardware wallet fully in SE execution of PQ signature
\item first full suite with secure element PQ signer to on chain contract verification (8051)
\item experimentations for the ZK endgame
